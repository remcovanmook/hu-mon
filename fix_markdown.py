...
new_table = """## 3. Consolidated Register Map (Function Code 04)
...
# Replace Section 3 entirely, but keep Section 4 and beyond!
pattern = r'## 3\. Input Register Map.*?---(?=\s*## 4\. Status and Error Decoding)'
replaced = re.sub(pattern, new_table + "\n---\n", text, flags=re.DOTALL)
