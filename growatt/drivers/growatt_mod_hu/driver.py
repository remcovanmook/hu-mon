...
-------------------------------------
  ...
  Detection: if Reg 3025 > 4000 (grid frequency x 100 > 40Hz) and
  Reg 3026 > 1000 (L1 voltage x 10 > 100V), the shifted profile is active.
"""
...
class GrowattModHuDriver(GrowattBaseDriver):
    ...
    def read_registers(self, client, slave_id: int) -> GrowattReading:
        ...
        # 3025: Fac (grid freq x 100). Threshold > 4000 -> 40 Hz -> plausible.
        # 3026: Vac1 (L1 voltage x 10). Threshold > 1000 -> 100 V -> plausible.
        ...
        # Total EPS power read directly from register (not computed from VxI).
