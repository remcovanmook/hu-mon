...
CREATE TABLE IF NOT EXISTS readings_5s (
    ...
    grid_ll_rs_v_mean REAL NOT NULL DEFAULT 0,
    grid_ll_st_v_mean REAL NOT NULL DEFAULT 0,
    grid_ll_tr_v_mean REAL NOT NULL DEFAULT 0,
    ...
    eps_l1_v_mean      REAL    NOT NULL DEFAULT 0,
    eps_l1_a_mean      REAL    NOT NULL DEFAULT 0,
    eps_l2_v_mean      REAL    NOT NULL DEFAULT 0,
    eps_l2_a_mean      REAL    NOT NULL DEFAULT 0,
    eps_l3_v_mean      REAL    NOT NULL DEFAULT 0,
    eps_l3_a_mean      REAL    NOT NULL DEFAULT 0,
...
INSERT INTO {table} (
    ...
    grid_ll_rs_v_mean, grid_ll_st_v_mean, grid_ll_tr_v_mean,
    ...
    grid_ll_rs_v_mean = (grid_ll_rs_v_mean * n + excluded.grid_ll_rs_v_mean) / (n + 1),
    grid_ll_st_v_mean = (grid_ll_st_v_mean * n + excluded.grid_ll_st_v_mean) / (n + 1),
    grid_ll_tr_v_mean = (grid_ll_tr_v_mean * n + excluded.grid_ll_tr_v_mean) / (n + 1),
...
class GrowattStore:
    ...
    def _get_row_tuple(self, ts_bucket: int, r: GrowattReading) -> tuple:
        return (
            ...
            r.grid_ll_rs_v, r.grid_ll_st_v, r.grid_ll_tr_v,
